...
// GANTI SESUAI SETTINGAN LAPTOP ANDA
// --- KONFIGURASI DATABASE NEON (CLOUD) ---
const pool = new Pool({
  // --- TEMPEL KODE DARI NEON DI BAWAH INI ---
  // Pastikan formatnya: 'postgres://user:password@alamat-asli-neon/database...'
  connectionString: 'postgresql://neondb_owner:npg_JIsie6qltHp0@ep-wispy-waterfall-aeygt2p0-pooler.c-2.us-east-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require', 
...
// --- 3. API ROUTES (JEMBATAN FRONTEND KE BACKEND) ---

// Ambil Semua Data (Produk & History)
...
// Ini rumit karena harus simpan history DAN kurangi stok sekaligus
...
app.listen(port, () => {
  console.log(`Server NeoPOS berjalan di http://localhost:${port}`);
});